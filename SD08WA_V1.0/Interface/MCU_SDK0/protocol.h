...
/******************************************************************************
                            1:修改产品信息                
******************************************************************************/
#define PRODUCT_KEY "cooesqpwgndiy9eo"//"8m0onkx2bao3q62i"    //开发平台创建产品后生成的16位字符产品唯一标识
...
//亮度值(可下发可上报)
//备注:
#define DPID_BRIGHT_VALUE 2 //29
//最小亮度(可下发可上报)
//备注:
#define DPID_BRIGHTNESS_MIN 101
//光源类型(可下发可上报)
//备注:
#define DPID_LED_TYPE 102
